...
export const metadata: Metadata = { title: "API tekshiruvi", description: "Elchi Market storefront va backend API ulanishini tekshirish sahifasi.", alternates: { canonical: "/api-test" }, robots: { index: false, follow: false } };
