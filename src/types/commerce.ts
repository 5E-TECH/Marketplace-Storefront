...
export type OrderStatus = "Yangi" | "Tayyorlanmoqda" | "Yo‘lda" | "Yetkazildi" | "Bekor qilindi" | "Qaytarildi";
export type Order = { id: string; createdAt: string; status: OrderStatus; customer: Customer; items: CartItem[]; subtotal: number; delivery: number; total: number; payment: "cash" | "card"; estimatedDeliveryAt?: string; updatedAt?: string; trackingUrl?: string; warning?: string };
