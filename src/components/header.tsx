...
import { ChevronDown, Grid2X2, Heart, MapPin, Menu, Search, ShoppingBag, UserRound, X } from "lucide-react";
  ...
  return <header className="header">
    ...
    <Container className="nav-wrap">
      ...
      <div className="header-actions">
        ...
        <Link className="header-nav-action header-cart" href="/cart" aria-label={cart.quantity ? `Savatcha: ${cart.quantity} ta mahsulot` : "Savatcha"} aria-busy={cart.loading || undefined}><i><ShoppingBag/>{cart.quantity > 0 && <span>{cart.quantity > 99 ? "99+" : cart.quantity}</span>}</i><b>Savat</b></Link>
      </div>
    </Container>
