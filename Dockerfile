...
# Online to'lov usullari ("payme,click"); bo'sh — faqat COD. Qiymat bundle'ga yoziladi.
ARG NEXT_PUBLIC_ONLINE_PAYMENTS=
ENV API_BASE_URL=${API_BASE_URL}
ENV MEDIA_BASE_URL=${MEDIA_BASE_URL}
ENV NEXT_PUBLIC_SITE_URL=${NEXT_PUBLIC_SITE_URL}
ENV NEXT_PUBLIC_ONLINE_PAYMENTS=${NEXT_PUBLIC_ONLINE_PAYMENTS}
