...
const names = ['StorefrontProductDto', 'StorefrontProductsPageDto', 'StorefrontShopPageDto', 'CategoryTreeDto', 'ProductDto', 'MyProductsPageDto', 'ProductVariantDto', 'CartDto', 'FavoritesPageDto'];
